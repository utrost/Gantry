...
| `--metrics FILE` | Also emit a JSON sidecar with layers, commands, strokes, points, draw/travel distance, travel ratio, tiny segment count, bounds, machine-readable warnings, and a plot-time estimate when `--config` is supplied |
