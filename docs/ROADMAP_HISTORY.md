# Gantry — Historical Roadmap (deprecated)
...
### Phase 10 — Per-area hatch styling (in progress; Tier 1 hatch styles complete)
...
- ✅ Added a colour→style table to both shared Process SVG surfaces:
