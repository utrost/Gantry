...
| `app` | `DocumentSessionTest`, `DocumentCompositionTest`, `GantryProjectIOTest` | Multi-level model undo/redo, append-SVG composition with side-by-side placement/unique command IDs, and `.gantry` project round-trip |
