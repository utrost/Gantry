...
public class HatchProcessor implements Processor {
    ...
    private boolean hatchShape(Document doc, Element target, Config config) {
        ...
        Shape localShape = org.trostheide.gantry.svgtoolbox.core.ShapeParser.parse(target);
        if (localShape == null)
            return false;
        ...
        org.trostheide.gantry.svgtoolbox.patterns.HatchPattern pattern;

        switch (patternName) {
            case "cross":
                pattern = new org.trostheide.gantry.svgtoolbox.patterns.CrossHatchPattern();
                break;
            case "zigzag":
                pattern = new org.trostheide.gantry.svgtoolbox.patterns.ZigZagHatchPattern();
                break;
            case "wave":
                pattern = new org.trostheide.gantry.svgtoolbox.patterns.WaveHatchPattern();
                break;
            case "dot":
                 pattern = new org.trostheide.gantry.svgtoolbox.patterns.DotHatchPattern();
                 break;
            case "linear":
            default:
                pattern = new org.trostheide.gantry.svgtoolbox.patterns.LinearHatchPattern();
                break;
        }
