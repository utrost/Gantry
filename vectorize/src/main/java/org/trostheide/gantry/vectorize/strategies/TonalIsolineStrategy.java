...
/** Marker strategy for the whole-image tonal-isoline raster workflow. */
public class TonalIsolineStrategy implements VectorizationStrategy {
    @Override
    public WorkflowType getWorkflowType() {
        return WorkflowType.TONAL_ISOLINES;
    }
