...
/**
 * A vectorization strategy that uses the 'imagetracerjava' library
 * (Brixomatic fork).
 *
 ...
 * full BufferedImage.
 */
public class ImageTracerStrategy implements VectorizationStrategy {
    ...
    public VectorGeometry processContour(List<Point2D_I32> rawPoints,
        ...
        throw new UnsupportedOperationException(
                "ImageTracerStrategy (bezier2) cannot be run on a single contour. " +
    ...
    public WorkflowType getWorkflowType() {
        return WorkflowType.WHOLE_IMAGE_IMAGETRACER;
    }
