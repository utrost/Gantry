...
/** Marker strategy for the whole-image sketch/blueprint trace workflow. */
public class SketchTraceStrategy implements VectorizationStrategy {
    @Override
    public WorkflowType getWorkflowType() {
        return WorkflowType.SKETCH_TRACE;
    }
